...
class Community: UIViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var messagingButton: UIBarButtonItem!
 ...
 */
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if self.startMessagingFromOpenChat == true {
            ...
            self.startSendBird("name", chatMode: kChatModeChatting, viewMode: kChannelListViewMode)
        }
    ...
    private func startSendBird(userName: String, chatMode: Int, viewMode: Int) {
        ...
        let APP_ID: String = "58B2A58E-B5BB-4AD8-B6B9-3D7696701DF5"
