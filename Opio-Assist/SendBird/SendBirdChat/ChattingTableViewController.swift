...
class ChattingTableViewController: UIViewController, ChatMessageInputViewDelegate, UITableViewDataSource, UITableViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        self.navigationController?.navigationBar.barTintColor = SendBirdUtils.UIColorFromRGB(0xD8D8D8)
        self.navigationController?.navigationBar.translucent = false
        
        self.navigationItem.rightBarButtonItem = UIBarButtonItem.init(image: UIImage.init(named: "speech-bubble"), style: UIBarButtonItemStyle.Plain, target: self, action: #selector(ChattingTableViewController.aboutSendBird(_:)))
 ...
 */
        ...
        print("starting")
            ...
            viewController.userName = "user"
            viewController.userId = SendBird.deviceUniqueID()
